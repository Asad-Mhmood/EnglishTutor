    ...
    <div ref={ref}>
      <section className="bg-background flex flex-col items-center justify-center text-center">
        ...
        <p className="text-foreground max-w-prose pt-1 leading-6 font-medium">
          Practice your English by talking with Alex
        </p>

        <p className="text-muted-foreground mt-2 max-w-prose text-sm leading-6 text-pretty">
          Alex is a patient AI tutor. Speak naturally about anything — Alex will chat back, gently
        ...
        <p
          role="status"
          aria-live="polite"
          className="text-destructive mt-3 h-4 max-w-prose text-xs leading-4"
        >
          {error}
        </p>

        <p className="text-muted-foreground mt-1 max-w-prose text-xs leading-5">
          Your browser will ask to use your microphone. Choose “Allow” so Alex can hear you.
        </p>
      </section>
